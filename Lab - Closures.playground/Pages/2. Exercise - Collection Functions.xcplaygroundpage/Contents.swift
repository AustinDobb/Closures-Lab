...
let names = ["Anthony", "Andrew", "Holly", "Alex", "Austin"]
var sortedCollection1 = names.sorted(by: forwards(name1:name2:))
...
let ownClosure = names.sorted { (nameUno, nameDos) -> Bool in
    
    return nameUno < nameDos
}
var sortedCollection2 = ownClosure
...
let noExtraSyntax = names.sorted(by: <)
let sortedCollection3 = noExtraSyntax
